...
const CTASection = () => (
  <section className="py-16 light-navy text-white">
    <div className="container mx-auto px-4 text-center">
      <h2 className="text-2xl md:text-4xl text-grey-800 font-bold mb-6 fade-in">Ready to Build Your Legacy?</h2>
      <p className=" text-base md:text-lg mb-10 max-w-2xl mx-auto fade-in">
