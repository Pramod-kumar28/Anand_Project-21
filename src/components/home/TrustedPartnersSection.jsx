  ...
  <section className="py-20 bg-white">
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="text-2xl md:text-4xl font-bold text-blue-800 mb-4 fade-in">Trusted Partners</h2>
        <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto fade-in">
