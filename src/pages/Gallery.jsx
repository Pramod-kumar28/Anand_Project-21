...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Robust and efficient industrial facilities built for optimal operations. We design manufacturing units and warehouses that maximize productivity and safety.',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive land planning and development services. We transform raw land into well-planned, sustainable communities and commercial zones.',
      features: [
      ...
      image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80'
    },
    {
      id: 5,
      icon: 'fas fa-tools',
      title: 'Public Utilities',
      description: 'Essential public infrastructure that serves communities. We build facilities that enhance public welfare and improve quality of life.',
      features: [
      ...
      image: 'https://images.unsplash.com/photo-1542361345-89e58247f2d5?ixlib=rb-4.1.0&auto=format&fit=crop&w=1350&q=60'
    },
    {
      id: 6,
      icon: 'fas fa-users',
      title: 'Community Infrastructure',
      description: 'Facilities that bring communities together and foster social development. We create spaces for education, healthcare, and recreation.',
      features: [
  ...
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <motion.section 
        className="relative py-20 md:py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.8, delay: 0.4 }}
            >
              Comprehensive Infrastructure Solutions Built to Last
            </motion.p>
            <motion.p
              className="text-lg text-blue-100 max-w-3xl mx-auto mb-10 leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
            >
              At Anand Infra, we deliver end-to-end infrastructure development services with scientific planning, 
              strict quality control, and Vastu-aligned designs that ensure balance, longevity, and well-being.
            </motion.p>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-blue-500 to-orange-500 mx-auto rounded-full mb-8"></div>
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              We specialize in creating timeless infrastructure across multiple sectors. From commercial complexes 
              to residential townships, industrial structures to public utilities, every project is built with 
              precision engineering and innovative design to become a lasting legacy.
            </p>
            <motion.div 
              className="bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-8 shadow-lg border border-gray-100"
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover the full spectrum of infrastructure development services we offer
            </p>
          </motion.div>
          ...
          >
            {services.map((service) => (
              <motion.div 
                key={service.id}
                className="bg-white rounded-xl shadow-lg overflow-hidden hover-lift border border-gray-100 group"
                variants={itemVariants}
                whileHover={{ 
                  y: -10,
                  transition: { duration: 0.3 }
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  ></motion.div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  {/* <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm w-14 h-14 rounded-xl flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-800 mb-4">
                Why Choose Anand Infra?
              </h2>
              <p className="text-lg text-gray-600">
                Our commitment to excellence sets us apart in the infrastructure development industry
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'We build infrastructure that stands strong for generations, using durable materials and proven techniques.'
                },
                {
                  icon: 'fas fa-ruler-combined',
                  title: 'Precision Engineering',
                  description: 'Every project undergoes meticulous planning and execution with attention to the smallest details.'
                },
                {
                  icon: 'fas fa-landmark',
                  title: 'Legacy Building',
                  description: 'We create iconic structures that become landmarks and leave a lasting legacy for communities.'
                },
                {
                  icon: 'fas fa-handshake',
                  title: 'Trusted Partnership',
                  description: 'Four decades of delivering on promises and building lasting relationships with our clients.'
                }
              ].map((item, index) => (
                <motion.div 
                  key={index}
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <i className={`${item.icon} text-blue-600 text-4xl mb-4`}></i>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto leading-relaxed">
              Whether you're planning a residential community, commercial complex, or public infrastructure project, 
              we have the expertise to make it a reality.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                to="/services" 
                className="border-2 border-white hover:bg-white hover:text-blue-800 px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300"
              >
                View Our Services
              </Link>
            </div>
